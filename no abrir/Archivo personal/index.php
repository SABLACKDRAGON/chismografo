...
$usuario = isset($_SESSION["usuario"]) ? $_SESSION["usuario"] : 'Usuario no definido';
$email = isset($_SESSION["email"]) ? $_SESSION["email"] : 'Correo no definido';
                ...
                <div class="col-sm-6">
                    <div class="contactinfo">
                        <ul class="nav nav-pills">
                            <li><a href="#"><i class="fa fa-phone"></i> +52 618 428 57 85</a></li>
                            <font color="green">
    ...
    <div class="header-middle"><!--header-middle-->
        <div class="container">
            <div class="row">
                ...
                <h3> Software Punto de venta de Ropa : ] </h3>
                <div class="col-sm-8">
                    Por: Aguilar Gracia Luis Abisai
                    ...
                    <div class="panel-group category-products" id="accordian"><!--category-productsr-->
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title" style="color: Black; font-size: 24px;"><a href="#">Caballeros</a></h4>
                                <h4 class="panel-title" style="color: Black; font-size: 24px;"><a href="#">Damas</a></h4>
                                <h4 class="panel-title" style="color: Black; font-size: 24px;"><a href="#">Niños</a></h4>
                                <h4 class="panel-title" style="color: Black; font-size: 24px;"><a href="#">Unisex</a></h4>
                            </div>
                        </div>
                        ...
                        <div class="product-image-wrapper">
                            <div class="single-products">
                                <div class="productinfo text-center">
                                    ...
                                    <h4><?php echo $productoB; ?></h4>
                                    <h2 style="color: orange; font-size: 24px;"><?php echo $precioB; ?></h2>
                                    <a href="cart.php?producto=<?php echo $productoB; ?>&precio=<?php echo $precioB; ?>" class="fa fa-shopping-cart"></a>Agregar al Carrito</a>
                                </div>

...
// Registro de artículos en el carrito
...
<body>
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="cart_description">
                                <h4><a href=""><?php echo htmlspecialchars($productoE); ?></a></h4>
                                <p>Web ID: 1089772</p>
                            </td>
                            <td class="cart_price">
                                <p><?php echo "$" . htmlspecialchars($precioE); ?></p>
                            </td>
                            ...
                            <td class="cart_total">
                                <p class="cart_total_price"><?php echo "$" . htmlspecialchars($precioE); ?></p>
                            </td>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="total_area">
                        ...
                        <a class="btn btn-default check_out" href="checkout.php" target="_blank">Ir a pagar</a>
                        <a class="btn btn-default check_out" href="index.php" target="_blank">Ver más</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <footer id="footer"><!--Footer-->
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <p class="pull-left">Copyright © 2023 E-SHOPPER Inc. Todos los Derechos Reservados</p>
